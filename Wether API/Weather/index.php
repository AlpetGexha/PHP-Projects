...
<div class="container wrapper">
    ...
    <div class="row">
        <h3 class="title text-center bordered"> Raporti i motit për <?php echo $current->city . ' (' . $current->country . ')'; ?></h3>
                ...
                <div class="row">
                    <div class="col-sm-9" style="font-size:20px;text-align:left;padding-left:70px;">
                        ...
                        <div class="weather-icon">
                            <p><strong>Shpejtesia e eres : </strong><?php echo $current->windspeed; ?> <?php echo $current->windspeed_unit; ?></p>
                            <p><strong>Presioni : </strong><?php echo $current->pressure; ?> <?php echo $current->pressure_unit; ?></p>
                            <p><strong>Dukshmëri : </strong><?php echo $current->visibility; ?> <?php echo $current->visibility_unit; ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <br><br>
    <div class="row">
        <h3 class="title text-center bordered">5 Ditë parashikimi i motit për <?php echo $current->city . ' (' . $current->country . ')'; ?></h3>
        <?php $loop = 0;
